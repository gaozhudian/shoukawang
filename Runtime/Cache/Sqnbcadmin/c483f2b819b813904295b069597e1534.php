...
<body>
    ...
    <div class="tw-layout">
	    ...
	    <div class="tw-list-wrap tw-edit-wrap">
            <form action="/Sqnbcadmin/Announcement/edit" method="post" class="form-horizontal ajaxForm">
                <div class="form-item">
                    <label class="item-label">公告名称<span class="check-tips"><b>*</b>（输入公告名称）</span></label>
                    <div class="controls">
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <textarea name="content" rows="5" cols="57"><?php echo ($info["content"]); ?></textarea><br/>
                    </div>
                </div>
    ...
    <script>
        _TARGET_URL="<?php echo U('Sqnbcadmin/Announcement/index');?>";
        UE.getEditor('UE',{
        ...
        $(function(){
            ...
            ajaxUpload('#btnUpload2', "#img2", 'Article', 2);
        })
    </script>
